...
<img src="/img/posts/img/posts/why-null-models-crispr/CRISPR_diagram_v3.svg" alt="crispr_diagram" width="250px" align="right" style="padding:15px;">
...
<img src="/img/posts/img/posts/why-null-models-crispr/Heler2019.svg" alt="Heler2019" width="250px" align="right" style="padding:15px;">
...
<img src="/img/posts/img/posts/why-null-models-crispr/model_diagram_simplified.png" alt="model" width="250px" align="right" style="padding:15px;">
...
<img src="/img/posts/img/posts/why-null-models-crispr/banfield_data_theory.svg" alt="banfield_data_theory" width="250px" align="right" style="padding:15px;">
...
Why does this matter? In lab experiments like those described here, you can do multiple copies of the same experiment under the same conditions to prove a result. But the world is full of conditions where this can never happen: any study of bacteria in a natural environment is inherently unreproducible: you can never turn back the clock and do things the same way twice. 
